...
class DataGenerator(object):
    ...
    def generate_dataset_in_random_mode(self, n, description_dic, seed=0, minimum=0, maximum=100):
        set_random_seed(seed)
        description = description_dic
    ...
    def generate_dataset_in_independent_mode(self, n, description_dic, seed=0):
        set_random_seed(seed)
        self.description = description_dic
    ...
    def generate_dataset_in_correlated_attribute_mode(self, n, description_dic, verbose=1, seed=0):
        set_random_seed(seed)
        self.n = n
        self.description = description_dic
        ...
        self.synthetic_dataset = DataFrame(columns=all_attributes)
        if verbose: print('================== Sampling from Bayesian Network ==================')
        for attr in all_attributes:
            attr_info = self.description['attribute_description'][attr]
            column = parse_json(attr_info)
